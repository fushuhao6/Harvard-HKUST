...
this->checkAND[7]  = 0b00000001;
this->checkAND[6]  = 0b00000010;
this->checkAND[5]  = 0b00000100;
this->checkAND[4]  = 0b00001000;
this->checkAND[3]  = 0b00010000;
this->checkAND[2]  = 0b00100000;
this->checkAND[1]  = 0b01000000;
this->checkAND[0]  = 0b10000000;
...
void LCD12864::DrawStr(char* str){
  for(char* it = str; *it; ++it) {
    setPins(1,0,(*it>>7)&1 , (*it>>6)&1, (*it>>5)&1, (*it>>4)&1, (*it>>3)&1, (*it>>2)&1, (*it>>1)&1, *it&1);
}
}
